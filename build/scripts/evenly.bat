...
@rem ##########################################################################
@rem
@rem  evenly startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and EVENLY_OPTS to pass JVM options to this script.
...
@rem Execute evenly
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EVENLY_OPTS%  -classpath "%CLASSPATH%" com.evenly.EvenlyApp %*
...
:fail
rem Set variable EVENLY_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%EVENLY_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
